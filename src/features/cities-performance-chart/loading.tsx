...
export default function BarChartSkeletonLoading() {
  return (
    <>
      <div role="status" className="0 w-full animate-pulse rounded   p-4  ">
        <div className="mb-2.5 h-2.5 w-32 rounded-full bg-primary/50 "></div>
        <div className="mb-10 h-2 w-48 rounded-full bg-primary/50 "></div>
