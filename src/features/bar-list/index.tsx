    ...
    <div className="flex flex-col items-center justify-start  ">
      {data.map((bar, index) => (
        ...
        >
          ...
          <div
            className="absolute right-0 top-1/2 z-0 flex h-12 -translate-y-1/2 transform-gpu justify-end rounded-xl bg-gradient-to-l from-primbuttn/50 to-primbuttn transition-all duration-1000"
