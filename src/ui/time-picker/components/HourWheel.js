    ...
    >
      ...
      >
        {hours.map((hourObj, index) => (
          <div
            key={index}
            className="flex w-full select-none items-center justify-start text-center transition-all duration-100 ease-linear"
          ...
          >
            <div
              ...
              ${hourObj.selected ? "text-primary " : "text-primary/40"}
              
              ${
                hourObj?.hidden ? "pointer-events-none invisible opacity-0" : ""
              }`}
