...
export function PowerLineMobile({ className = "" }) {
  return (
    <svg
      className={className}
      width="400"
    ...
    >
      ...
      <defs>
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FF4A81"></stop>
          <stop offset="0.219" stopColor="#DF6CF7"></stop>
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FF7432"></stop>
          <stop offset="0.219" stopColor="#F7CC4B"></stop>
        ...
        >
          ...
          <stop offset="0.219" stopColor="#61DAFB"></stop>
          <stop offset="1" stopColor="#61DAFB" stopOpacity="0"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
