...
export function PowerLine({ className = "" }) {
  return (
    <svg
      className={className}
      width="891"
    ...
    >
      <g clipPath="url(#clip0_7_94)">
        ...
        <path
          ...
          strokeWidth="2"
          d="M547 130h275a4 4 0 014 4v130"
        ></path>
        <path
          stroke="#fff"
          strokeDasharray="1 1"
      ...
      <defs>
        ...
        <clipPath id="clip0_7_94">
          <path fill="#fff" d="M0 0H891V264H0z"></path>
        </clipPath>
      </defs>
    </svg>
  );
